...
public class AbeyTransactionDecoder {

    public static AbeyRawTransaction decode(final String hexTransaction) {
        ...
        if (values.getValues().size() == 8
            ...
            return AbeyRawTransaction.createAbeyPaymentAndFeeTransaction(nonce, gasPrice, gasLimit, to, value, data,fee,payment);
        } else {
            ...
            return new SignedAbeyRawTransaction(
