...
public interface AbeyjRx {
     ...
     *     blockchain
     */
    Flowable<AbeyBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<AbeyBlock> replayPastBlocksFlowable(
     ...
     *     in the {@link AbeyBlock} responses
     ...
     */
    Flowable<AbeyBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
