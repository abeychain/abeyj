 ...
 */
public class AbeySyncing extends Response<AbeySyncing.Result> {

    @Override
    @JsonDeserialize(using = AbeySyncing.ResponseDeserialiser.class)
    public void setResult(AbeySyncing.Result result) {
