...
public abstract class ManagedTransaction {
    ...
    protected Abeyj abeyj;

    protected TransactionManager transactionManager;

    protected EnsResolver ensResolver;

    protected ManagedTransaction(Abeyj abeyj, TransactionManager transactionManager) {
        this(new EnsResolver(abeyj), abeyj, transactionManager);
    }

    protected ManagedTransaction(
            EnsResolver ensResolver, Abeyj abeyj, TransactionManager transactionManager) {
    ...
    public BigInteger requestCurrentGasPrice() throws IOException {
        AbeyGasPrice abeyGasPrice = abeyj.abeyGasPrice().send();

        return abeyGasPrice.getGasPrice();
    }
