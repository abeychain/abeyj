...
import org.abeyj.tx.gas.StaticGasProvider;
...
public abstract class Contract extends ManagedTransaction {
    ...
    /**
     * @deprecated ...
     * @see org.abeyj.tx.gas.DefaultGasProvider
     */
    ...
    protected Contract(
        ...
        super(ensResolver, abeyj, transactionManager);
    ...
    protected Contract(
        ...
        this(
                ...
                contractAddress,
                abeyj,
                new RawTransactionManager(abeyj, credentials),
                gasProvider);
    }
    ...
    protected Contract(
            ...
            BigInteger gasPrice,
            BigInteger gasLimit) {
        this("", contractAddress, abeyj, transactionManager, gasPrice, gasLimit);
    }
     ...
     * @throws IOException if unable to connect to abeyj node
     */
        ...
        if (contractAddress.equals("")) {
            throw new UnsupportedOperationException(
                    "Contract binary not present, you will need to regenerate your smart "
                            + "contract wrapper with abeyj v2.2.0+");
        }

        AbeyGetCode abeyGetCode =
                transactionManager.getCode(contractAddress, DefaultBlockParameterName.LATEST);
        if (abeyGetCode.hasError()) {
            return false;
        }

        String code = Numeric.cleanHexPrefix(abeyGetCode.getCode());
            ...
            throw new TransactionException(
                    String.format(
                            ...
                            receipt.getGasUsedRaw() != null
                                    ...
                                    : "unknown",
                            extractRevertReason(receipt, data, abeyj, true)),
                    receipt);
        }
        return receipt;
    }
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            T contract = constructor.newInstance(null, abeyj, credentials, contractGasProvider);
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            // we want to use null here to ensure that "to" parameter on message is not populated
            T contract =
                    constructor.newInstance(null, abeyj, transactionManager, contractGasProvider);
            return create(contract, binary, encodedConstructor, value);
        } catch (TransactionException e) {
            throw e;
        } catch (Exception e) {
