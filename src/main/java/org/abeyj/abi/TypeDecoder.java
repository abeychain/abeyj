...
import org.abeyj.abi.datatypes.generated.Uint160;
...
import static org.abeyj.abi.DefaultFunctionReturnDecoder.getDataOffset;
import static org.abeyj.abi.TypeReference.makeTypeReference;
import static org.abeyj.abi.Utils.getSimpleTypeName;
import static org.abeyj.abi.Utils.staticStructNestedPublicFieldsFlatList;
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (value instanceof List) {
            ...
            throw new ClassCastException(
                    "Arg of type "
                            + value.getClass()
                            + " should be a list to instantiate abeyj Array");
        }
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("org.abeyj.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("org.abeyj.abi.datatypes.generated.StaticArray" + length);
