...
import org.abeyj.abi.datatypes.Event;
...
import org.abeyj.abi.datatypes.generated.Uint64;
...
public class ENS extends Contract {
    ...
    @Deprecated
    protected ENS(String contractAddress, Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, abeyj, credentials, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, abeyj, credentials, contractGasProvider);
    }

    @Deprecated
    protected ENS(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, abeyj, transactionManager, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setSubnodeOwner(byte[] node, byte[] label, String owner) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Bytes32(label),
                new org.abeyj.abi.datatypes.Address(owner)),
    ...
    public RemoteCall<TransactionReceipt> setTTL(byte[] node, BigInteger ttl) {
        final Function function = new Function(
                FUNC_SETTTL,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Uint64(ttl)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setResolver(byte[] node, String resolver) {
        final Function function = new Function(
                FUNC_SETRESOLVER,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.Address(resolver)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<ENS> deploy(Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, abeyj, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, abeyj, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, abeyj, credentials, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, abeyj, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public Flowable<NewOwnerEventResponse> newOwnerEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewOwnerEventResponse>() {
            @Override
    ...
    public Flowable<TransferEventResponse> transferEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TransferEventResponse>() {
            @Override
    ...
    public Flowable<NewResolverEventResponse> newResolverEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewResolverEventResponse>() {
            @Override
    ...
    public Flowable<NewTTLEventResponse> newTTLEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewTTLEventResponse>() {
            @Override
    ...
    @Deprecated
    public static ENS load(String contractAddress, Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, abeyj, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ENS load(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, abeyj, transactionManager, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, abeyj, credentials, contractGasProvider);
    }

    public static ENS load(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, abeyj, transactionManager, contractGasProvider);
    }
