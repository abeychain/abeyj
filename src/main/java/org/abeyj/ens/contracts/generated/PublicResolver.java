package org.abeyj.ens.contracts.generated;

import io.reactivex.Flowable;
import org.abeyj.abi.EventEncoder;
...
public class PublicResolver extends Contract {
    ...
    @Deprecated
    protected PublicResolver(String contractAddress, Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, abeyj, credentials, gasPrice, gasLimit);
    }

    protected PublicResolver(String contractAddress, Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, abeyj, credentials, contractGasProvider);
    }

    @Deprecated
    protected PublicResolver(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, abeyj, transactionManager, gasPrice, gasLimit);
    }

    protected PublicResolver(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteCall<TransactionReceipt> setText(byte[] node, String key, String value) {
        final Function function = new Function(
                FUNC_SETTEXT, 
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.Utf8String(key),
                new org.abeyj.abi.datatypes.Utf8String(value)),
    ...
    public RemoteCall<Tuple2<BigInteger, byte[]>> ABI(byte[] node, BigInteger contentTypes) {
        final Function function = new Function(FUNC_ABI,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Uint256(contentTypes)),
    ...
    public RemoteCall<TransactionReceipt> setPubkey(byte[] node, byte[] x, byte[] y) {
        final Function function = new Function(
                FUNC_SETPUBKEY,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Bytes32(x),
                new org.abeyj.abi.datatypes.generated.Bytes32(y)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setABI(byte[] node, BigInteger contentType, byte[] data) {
        final Function function = new Function(
                FUNC_SETABI,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Uint256(contentType),
                new org.abeyj.abi.datatypes.DynamicBytes(data)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setName(byte[] node, String name) {
        final Function function = new Function(
                FUNC_SETNAME,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.Utf8String(name)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setContent(byte[] node, byte[] hash) {
        final Function function = new Function(
                FUNC_SETCONTENT,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.generated.Bytes32(hash)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> setAddr(byte[] node, String addr) {
        final Function function = new Function(
                FUNC_SETADDR,
                Arrays.<Type>asList(new org.abeyj.abi.datatypes.generated.Bytes32(node),
                new org.abeyj.abi.datatypes.Address(addr)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public static RemoteCall<PublicResolver> deploy(Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.abeyj.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, abeyj, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<PublicResolver> deploy(Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.abeyj.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, abeyj, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.abeyj.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, abeyj, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.abeyj.abi.datatypes.Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, abeyj, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public Flowable<AddrChangedEventResponse> addrChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, AddrChangedEventResponse>() {
            @Override
    ...
    public Flowable<AddrChangedEventResponse> addrChangedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        AbeyFilter filter = new AbeyFilter(startBlock, endBlock, getContractAddress());
    ...
    public Flowable<ContentChangedEventResponse> contentChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ContentChangedEventResponse>() {
            @Override
    ...
    public Flowable<NameChangedEventResponse> nameChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NameChangedEventResponse>() {
            @Override
    ...
    public Flowable<ABIChangedEventResponse> aBIChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ABIChangedEventResponse>() {
            @Override
    ...
    public Flowable<PubkeyChangedEventResponse> pubkeyChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, PubkeyChangedEventResponse>() {
            @Override
    ...
    public Flowable<TextChangedEventResponse> textChangedEventFlowable(AbeyFilter filter) {
        return abeyj.ethLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TextChangedEventResponse>() {
            @Override
    ...
    @Deprecated
    public static PublicResolver load(String contractAddress, Abeyj abeyj, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, abeyj, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PublicResolver load(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, abeyj, transactionManager, gasPrice, gasLimit);
    }

    public static PublicResolver load(String contractAddress, Abeyj abeyj, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, abeyj, credentials, contractGasProvider);
    }

    public static PublicResolver load(String contractAddress, Abeyj abeyj, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, abeyj, transactionManager, contractGasProvider);
    }
